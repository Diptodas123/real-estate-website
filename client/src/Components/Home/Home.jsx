...
import buyProperty from "../../Data/BuyCategories.js";
import rentProperty from "../../Data/RentCategories.js";
import testimonials from "../../Data/Testimonials";
import { toast, ToastContainer } from "react-toastify";
import Footer from "../Footer/Footer";
const Home = () => {
    const [salesData, setSalesData] = useState(buyProperty);
    const [renstData, setRentsData] = useState(rentProperty);
        ...
        <>
            ...
            <div className="container mt-5 text-center home-content">
                ...
                <div className="row">
                    {
                        rent.map((value) => {
                            const { photo, photoAlt, rentHeading, bhk, buyPrize, sqftIcon, sqft, persqft, statusIcon, status, stairIcon, floors, cardDesc, buildStatus, buildStatusText } = value;
                            return (
                                <div className="col-lg-3 col-md-6 col-sm-12">
                                    <div className="card mb-2">
                                        <img src={photo} alt={photo} className="mb-2"></img>
                                        <h5><b>{rentHeading}</b></h5>
                                    </div>
                                </div>
                            )
                        })
