...
const Form = () =>{
    ...
    return(
        <>
            <div className="container-fluid mb-5 form-body">
                <form>
                            ...
                            <div className="row">
                                <div className="col-12 col-md-4 form-filed">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="photo" onChange={onValueChange} class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" multiple placeholder="Upload Photos of the Property" />
                                    </div>
                                </div>
                                <div className="col-12 col-md-4 form-filed">
                                    <div class="form-group">
