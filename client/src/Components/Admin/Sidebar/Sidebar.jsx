                    ...
                    <nav id="sidebarMenu" className="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                        <div className="sidebar-sticky">
                            <ul className="nav flex-column">
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/adminuser" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/adminbuypage" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/adminrentpage" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/barchart" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/linechart" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/piechart" onClick={backToTop}>
                                ...
                                <li className="nav-item">
                                    <Link className="nav-link" to="/adminlogin" onClick={backToTop}>
